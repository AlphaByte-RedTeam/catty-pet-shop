...
<head>
    ...
    <title>CMS Catty Pet Shop | About Us List</title>
...
<body>
    ...
    <div class="container mt-3">
        <h2>ABOUT US LIST</h2>
        <a href="../form_tambah_aboutus.php"><button type="button" class="btn btn-primary">Tambah </button></a>
        ...
        <table class="table table-hover">
            ...
            <tbody>
                <?php
                $sql = "";
                $sql = "select * from tb_aboutus order by id_aboutus";
                ...
                ?>
                        ...
                        <tr>
                            <td><?php echo $id_aboutus; ?></td>
                            <td><?php echo $title_aboutus; ?></td>
                            <td><?php echo $desc_aboutus; ?></td>
                            <td><?php echo $img_aboutus; ?></td>
                            <td>
                                <?php if ($flag == 1) : ?>
                                    active
                                <?php else : ?>
                            ...
                            <td><a href="../form_ubah_aboutus.php?id=<?php echo $id_aboutus; ?>">Update</a></td>
                            <td><a onClick="return konfirmasi_hapus();" href="../helper/hapus_aboutus.php?id=<?php echo $id_aboutus; ?>">Delete </a> </td>
                        </tr>
                <?php
                    }
                }
