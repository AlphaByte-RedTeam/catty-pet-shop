...
<head>
  ...
  <title>CMS Catty Pet Shop | Ubah Member</title>
...
<body>
  ...
  $sql = "";
  $sql = " select * from tb_member where id_member ='$id_member' limit 1";
  ...
  <div class="container mt-3">
    <h2>Ubah Member</h2>
    <form action="helper/simpan_ubah_member.php" method="post" onSubmit="return konfirmasi_ubah();">
      ...
      <div class="form-check">
        <input type="checkbox" class="form-check-input" id="isAdmin" name="isAdmin" <?php if ($priv==1): ?> checked <?php endif; ?>>
      ...
      <a href="list/user_list.php"><button type="button" class="btn btn-info">Cancel</button></a>
    </form>
  </div>
</body>
