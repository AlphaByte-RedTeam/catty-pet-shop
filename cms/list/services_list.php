...
<head>
    ...
    <title>CMS Catty Pet Shop | Service List</title>
...
<body>
    ...
    <div class="container mt-3">
        <h2>SERVICES LIST</h2>
        <a href="../form_tambah_service.php"><button type="button" class="btn btn-primary">Tambah </button></a>
        ...
        <table class="table table-hover">
            ...
            <tbody>
                <?php
                $sql = "";
                $sql = "select * from tb_service order by id_service";
                ...
                ?>
                        <tr>
                            ...
                            <td><a href="../form_ubah_service.php?id=<?php echo $id_service; ?>">Update</a></td>
                            <td><a onClick="return konfirmasi_hapus();" href="../helper/hapus_service.php?id=<?php echo $id_service; ?>">Delete </a> </td>
                        </tr>
                <?php
                    }
                }
