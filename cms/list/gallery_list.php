...
<head>
    ...
    <title>CMS Catty Pet Shop | Gallery List</title>
    ...
    <div class="container mt-3">
        ...
        <table class="table table-hover">
            ...
            <tbody>
                <?php
                $sql = "";
                $sql = "select * from tb_gallery order by id_gallery";
                ...
                ?>
                        ...
                        <tr>
                            ...
                            <td><?php echo $img_gallery; ?></td>
                            <td><?php echo $alt_gallery; ?></td>
                            <td>
                                <?php if ($flag == 1) : ?>
                                    active
                                <?php else : ?>
                            ...
                            <td><a href="../form_ubah_gallery.php?id=<?php echo $id_gallery; ?>">Update</a></td>
                            <td><a onClick="return konfirmasi_hapus();" href="../helper/hapus_gallery.php?id=<?php echo $id_gallery; ?>">Delete </a> </td>
                        </tr>
                <?php
                    }
                }
