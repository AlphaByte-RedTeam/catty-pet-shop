...
<head>
  ...
  <title>CMS Catty Pet Shop | Tambah Coreval</title>
...
<body>
  ...
  <div class="container mt-3">
    <h2>Tambah Coreval</h2>
    <form action="helper/simpan_tambah_coreval.php" method="post" onSubmit="return konfirmasi_tambah();">

      <div class="mb-3 mt-3">
        <label for="title_coreval">Title:</label>
        <input type="text" class="form-control" id="title_coreval" placeholder="Enter Title" name="title_coreval" required>
      </div>
      <div class="mb-3 mt-3">
        <label for="desc_coreval">Description:</label>
        <input type="text" class="form-control" id="desc_coreval" placeholder="Enter Desc" name="desc_coreval" required>
      </div>
      <div class="mb-3 mt-3">
        <label for="src_coreval">Source:</label>
        <textarea id="src_coreval" name="src_coreval" rows="3" cols="120" placeholder="Enter src" required>
	      </textarea>
      </div>
