...
<head>
  ...
  <title>CMS Catty Pet Shop | Ubah Gallery</title>
...
<body>
  ...
  $sql = "";
  $sql = " select * from tb_gallery where id_gallery ='$id_gallery' limit 1";
  ...
  <div class="container mt-3">
    <h2>Ubah Gallery</h2>
    <form action="helper/simpan_ubah_gallery.php" method="post" onSubmit="return konfirmasi_ubah();">

      <div class="mb-3 mt-3">
        <label for="id_gallery">Id:</label>
        <input type="text" class="form-control" readonly id="id_gallery" name="id_gallery" value="<?php echo $id_gallery; ?>">
      </div>

      <div class="mb-3 mt-3">
        <label for="img_gallery">Img:</label>
        <input type="file" class="form-control" id="img_gallery" placeholder="Enter Img" name="img_gallery" value="<?php echo $img_gallery; ?>" required>
      </div>

      <div class="mb-3 mt-3">
        <label for="alt_gallery">Alt:</label>
        <input type="file" class="form-control" id="alt_gallery" placeholder="Enter Alt" name="alt_gallery" value="<?php echo $alt_gallery; ?>" required>
      </div>
      ...
      <a href="list/gallery_list.php"><button type="button" class="btn btn-info">Cancel</button></a>
    </form>
  </div>
</body>
