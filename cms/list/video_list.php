...
<head>
    ...
    <title>CMS Catty Pet Shop | Video List</title>
...
<body>
    ...
    <div class="container mt-3">
        <h2>Video LIST</h2>
        <a href="../form_tambah_video.php"><button type="button" class="btn btn-primary">Tambah </button></a>
        ...
        <table class="table table-hover">
            ...
            <tbody>
                <?php
                $sql = "";
                $sql = "select * from tb_video order by id_video";
                ...
                ?>
                        ...
                        <tr>
                            <td><?php echo $id_video;?></td>
					        <td><?php echo $title_video;?></td>
                            <td><?php echo $desc_video;?></td>
                            ...
                            <td><a href="../form_ubah_video.php?id=<?php echo $id_video; ?>">Update</a></td>
                            <td><a onClick="return konfirmasi_hapus();" href="../helper/hapus_video.php?id=<?php echo $id_video; ?>">Delete </a> </td>
                        </tr>
                <?php
                    }
                }
