...
<head>
  ...
  <title>CMS Catty Pet Shop | Tambah Member</title>
...
<body>
  ...
  <div class="container mt-3">
    <h2>Tambah Member</h2>
    <form action="helper/simpan_tambah_member.php" method="post" onSubmit="return konfirmasi_tambah();">
      ...
      <div class="mb-3 mt-3">
        ...
        <input type="password" class="form-control" id="member_password" placeholder="Enter password" name="member_password" required>
      </div>
