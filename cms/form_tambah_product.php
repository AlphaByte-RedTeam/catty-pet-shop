...
<head>
  ...
  <title>CMS Catty Pet Shop | Tambah Product</title>
...
<body>
  ...
  <div class="container mt-3">
    ...
    <form action="helper/simpan_tambah_product.php" method="post" onSubmit="return konfirmasi_tambah();">
      ...
      <div class="mb-3 mt-3">
        ...
        <input type="text" class="form-control" id="product_desc" placeholder="Enter Desc" name="product_desc" required>
      </div>
      <div class="mb-3 mt-3">
        <label for="product_price">Price:</label>
        <input type="text" class="form-control" id="product_price" placeholder="Enter Price" name="product_price" required>
      </div>
      <div class="mb-3 mt-3">
        <label for="product_disc">Disc:</label>
        <input type="text" class="form-control" id="product_disc" placeholder="Enter Disc" name="product_disc" required>
      </div>
      <div class="mb-3 mt-3">
        <label for="product_img">Img:</label>
        <input type="file" class="form-control" id="product_img" placeholder="Enter Img" name="product_img" required>
      </div>
