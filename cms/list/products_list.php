...
<head>
    ...
    <title>CMS Catty Pet Shop | Product List</title>
...
<body>
    ...
    <div class="container mt-3">
        <h2>PRODUCT LIST</h2>
        <a href="../form_tambah_product.php"><button type="button" class="btn btn-primary">Tambah </button></a>
        ...
        <table class="table table-hover">
            ...
            <tbody>
                <?php
                $sql = "";
                $sql = "select * from tb_product order by id_product";
                ...
                ?>
                        ...
                        <tr>
                            ...
                            <td><a href="../form_ubah_product.php?id=<?php echo $id_product; ?>">Update</a></td>
                            <td><a onClick="return konfirmasi_hapus();" href="../helper/hapus_product.php?id=<?php echo $id_product; ?>">Delete </a> </td>
                        </tr>
                <?php
                    }
                }
