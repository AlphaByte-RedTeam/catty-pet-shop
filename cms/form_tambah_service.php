...
<head>
  ...
  <title>CMS Catty Pet Shop | Tambah Service</title>
...
<body>
  ...
  <div class="container mt-3">
    ...
    <form action="helper/simpan_tambah_service.php" method="post" onSubmit="return konfirmasi_tambah();">

      <div class="mb-3 mt-3">
        <label for="title_service">Title:</label>
        <input type="text" class="form-control" id="title_service" placeholder="Enter Title" name="title_service" required>
      </div>
      <div class="mb-3 mt-3">
        <label for="img_service">Img:</label>
        <input type="file" class="form-control" id="img_service" placeholder="Enter Img" name="img_service" required>
      </div>
