...
<head>
  ...
  <title>CMS Catty Pet Shop | Tambah Video</title>
...
<body>
  ...
  <div class="container mt-3">
    <h2>Tambah Video</h2>
    <form action="helper/simpan_tambah_video.php" method="post" onSubmit="return konfirmasi_tambah();">

      <div class="mb-3 mt-3">
        <label for="title_video">Title:</label>
        <input type="text" class="form-control" id="title_video" placeholder="Enter Title" name="title_video" required>
      </div>
      <div class="mb-3 mt-3">
        <label for="desc_video">Description:</label>
        <textarea id="desc_video" name="desc_video" rows="3" cols="120" placeholder="Enter description" required>
	      </textarea>
      
      </div>
      <div class="mb-3 mt-3">
        <label for="file_video">Video:</label>
        <input type="file" class="form-control" id="file_video" placeholder="Enter Video" name="file_video">
      </div>
      <div class="mb-3 mt-3">
        <label for="file_image">Image:</label>
        <input type="file" class="form-control" id="file_image" placeholder="Enter Video" name="file_image" >
      </div>
