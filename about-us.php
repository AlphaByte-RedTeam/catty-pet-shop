            ...
            <div class="container">
                ...
                <div class="container">
                    <div class="row p-5">
                        ...
                        <?php
                        $sSQL = "SELECT * FROM tb_aboutus";
                        $result = mysqli_query($conn, $sSQL);

                        if (mysqli_num_rows($result) > 0) :
                            while ($row = mysqli_fetch_assoc($result)) :
                                if ($row['flag_active'] != 0) : // Check if active, delete this (and the first endif below) if flag active is not used
                                    $title = $row['title_aboutus'];
                                    $desc = $row['desc_aboutus'];
                                    $image = $row['img_aboutus'];
                        ?>

                                    <div class="col-md text-center">
                                        <div class="card my-2">
                                            <div class="card-body">
                                                <?php echo '<img src="images/about-us/' . $image . '" style="width :200px; height:200px" alt=" " class="rounded-pill">' ?>
                                                <h4 class="card-title">
                                                    <?php echo $title; ?>
                                                </h4>
                                                <p class="card-text">
                        ...
                        <!-- <div class="col-md text-center">
                                <div class="card my-2">
                                    <div class="card-body">
                                        <img src="images/about-us/award.jpg" style ="width :200px; height:200px" alt=" " class="rounded-pill">
                                        <h4 class="card-title">
                                            85+
                                        </h4>
                                        <p class="card-text">
                            ...
                            <div class="col-md text-center">
                                <div class="card my-2">
                                    <div class="card-body">
                                        <img src="images/about-us/clients.jpg" style ="width :200px; height:200px" alt=" " class="rounded-pill">
                                        <h4 class="card-title">
                                            99K
                                        </h4>
                                        <p class="card-text">
                            ...
                            <div class="col-md text-center">
                                <div class="card my-2">
                                    <div class="card-body">
                                        <img src="images/about-us/protection.jpg" style ="width :200px; height:200px" alt=" " class="rounded-pill">
                                        <h4 class="card-title">
                                            99%
                                        </h4>
                                        <p class="card-text">
